...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
  <header class="mdl-layout__header">
    <div class="mdl-layout__header-row">
      ...
      <nav class="mdl-navigation mdl-layout--large-screen-only">Check performed at Sat Oct 05 18:24:43 IST 2024 by AGP (8.5.0)</nav>
    </div>
  </header>
...
<span class="location"><a href="../../src/main/java/com/oney/WebRTCModule/SerializeUtils.java">../../src/main/java/com/oney/WebRTCModule/SerializeUtils.java</a>:72</span>: <span class="message">Implicitly using the default locale is a common source of bugs: Use <code>toLowerCase(Locale)</code> instead. For strings meant to be internal use <code>Locale.ROOT</code>, otherwise <code>Locale.getDefault()</code>.</span><br /><pre class="errorlines">
<span class="lineno">  69 </span>        trackInfo.putInt(<span class="string">"peerConnectionId"</span>, pcId);
<span class="lineno">  70 </span>        trackInfo.putString(<span class="string">"kind"</span>, track.kind());
<span class="lineno">  71 </span>        trackInfo.putBoolean(<span class="string">"enabled"</span>, track.enabled());
<span class="caretline"><span class="lineno">  72 </span>        trackInfo.putString(<span class="string">"readyState"</span>, track.state().toString().<span class="warning">toLowerCase</span>());&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  73 </span>        trackInfo.putBoolean(<span class="string">"remote"</span>, <span class="keyword">true</span>);
<span class="lineno">  74 </span>        <span class="keyword">return</span> trackInfo;
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:34</span>: <span class="message">A newer version of androidx.core:core than 1.7.0 is available: 1.13.1</span><br /><pre class="errorlines">
<span class="lineno"> 31 </span>dependencies {
<span class="lineno"> 32 </span>    implementation <span class="string">'com.facebook.react:react-native:+'</span>
<span class="lineno"> 33 </span>    api <span class="string">'io.github.webrtc-sdk:android:125.6422.04'</span>
<span class="caretline"><span class="lineno"> 34 </span>    implementation <span class="warning"><span class="string">"androidx.core:core:1.7.0"</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:32</span>: <span class="message">Avoid using + in version numbers; can lead to unpredictable and unrepeatable builds (com.facebook.react:react-native:+)</span><br /><pre class="errorlines">
<span class="lineno"> 29 </span>}
<span class="lineno"> 30 </span>
<span class="lineno"> 31 </span>dependencies {
<span class="caretline"><span class="lineno"> 32 </span>    implementation <span class="warning"><span class="string">'com.facebook.react:react-native:+'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 33 </span>    api <span class="string">'io.github.webrtc-sdk:android:125.6422.04'</span>
<span class="lineno"> 34 </span>    implementation <span class="string">"androidx.core:core:1.7.0"</span>
<span class="lineno"> 35 </span>}
</pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/oney/WebRTCModule/MediaProjectionNotification.java">../../src/main/java/com/oney/WebRTCModule/MediaProjectionNotification.java</a>:73</span>: <span class="message">Use of this function is discouraged because resource reflection makes it harder to perform build optimizations and compile-time verification of code. It is much more efficient to retrieve resources by identifier (e.g. <code>R.foo.bar</code>) than by name (e.g. <code>getIdentifier("bar", "foo", null)</code>).</span><br /><pre class="errorlines">
<span class="lineno"> 70 </span>          .setAutoCancel(<span class="keyword">true</span>)
<span class="lineno"> 71 </span>          .setVisibility(NotificationCompat.VISIBILITY_PUBLIC)
<span class="lineno"> 72 </span>          .setOnlyAlertOnce(<span class="keyword">true</span>)
<span class="caretline"><span class="lineno"> 73 </span>          .setSmallIcon(context.getResources().<span class="warning">getIdentifier</span>(<span class="string">"ic_notification"</span>, <span class="string">"drawable"</span>, context.getPackageName()))</span>
<span class="lineno"> 74 </span>          .setForegroundServiceBehavior(NotificationCompat.FOREGROUND_SERVICE_IMMEDIATE);
<span class="lineno"> 75 </span>
<span class="lineno"> 76 </span>  <span class="keyword">return</span> builder.build();
</pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/oney/WebRTCModule/EglUtils.java">../../src/main/java/com/oney/WebRTCModule/EglUtils.java</a>:34</span>: <span class="message">Unnecessary; SDK_INT is always >= 24</span><br /><pre class="errorlines">
<span class="lineno"> 31 </span>  <span class="keyword">try</span> {
<span class="lineno"> 32 </span>      <span class="comment">// WebRTC internally does this check in isEGL14Supported, but it's no longer exposed</span>
<span class="lineno"> 33 </span>      <span class="comment">// in the public API</span>
<span class="caretline"><span class="lineno"> 34 </span>      <span class="keyword">if</span> (<span class="warning">VERSION.SDK_INT >= <span class="number">18</span></span>) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 35 </span>          eglBase = EglBase.createEgl14(configAttributes);
<span class="lineno"> 36 </span>      }
<span class="lineno"> 37 </span>  } <span class="keyword">catch</span> (RuntimeException ex) {
</pre>
