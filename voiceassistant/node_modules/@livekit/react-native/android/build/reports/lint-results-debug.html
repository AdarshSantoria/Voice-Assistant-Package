...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
  <header class="mdl-layout__header">
    <div class="mdl-layout__header-row">
      ...
      <nav class="mdl-navigation mdl-layout--large-screen-only">Check performed at Sat Oct 05 18:24:42 IST 2024 by AGP (8.5.0)</nav>
    </div>
  </header>
  <div class="mdl-layout__drawer">
    ...
    <nav class="mdl-navigation">
      ...
      <a class="mdl-navigation__link" href="#InlinedApi"><i class="material-icons warning-icon">warning</i>Using inlined constants on older versions (3)</a>
...
<span class="location"><a href="../../src/main/java/com/livekit/reactnative/audio/AudioManagerUtils.kt">../../src/main/java/com/livekit/reactnative/audio/AudioManagerUtils.kt</a>:19</span>: <span class="message">Field requires API level 30 (current min is 24): <code>android.media.AudioManager#MODE_CALL_SCREENING</code></span><br /><pre class="errorlines">
<span class="lineno">  16 </span>        <span class="keyword">var</span> audioMode: Int? = <span class="keyword">null</span>
<span class="lineno">  17 </span>        <span class="keyword">when</span> (audioModeString) {
<span class="lineno">  18 </span>            <span class="string">"normal"</span> -> audioMode = AudioManager.MODE_NORMAL
<span class="caretline"><span class="lineno">  19 </span>            <span class="string">"callScreening"</span> -> audioMode = <span class="warning">AudioManager.MODE_CALL_SCREENING</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  20 </span>            <span class="string">"inCall"</span> -> audioMode = AudioManager.MODE_IN_CALL
<span class="lineno">  21 </span>            <span class="string">"inCommunication"</span> -> audioMode = AudioManager.MODE_IN_COMMUNICATION
<span class="lineno">  22 </span>            <span class="string">"ringtone"</span> -> audioMode = AudioManager.MODE_RINGTONE
</pre>

<span class="location"><a href="../../src/main/java/com/livekit/reactnative/audio/AudioManagerUtils.kt">../../src/main/java/com/livekit/reactnative/audio/AudioManagerUtils.kt</a>:56</span>: <span class="message">Field requires API level 26 (current min is 24): <code>android.media.AudioAttributes#USAGE_ASSISTANT</code></span><br /><pre class="errorlines">
<span class="lineno">  53 </span>  <span class="string">"assistanceAccessibility"</span> -> AudioAttributes.USAGE_ASSISTANCE_ACCESSIBILITY
<span class="lineno">  54 </span>  <span class="string">"assistanceNavigationGuidance"</span> -> AudioAttributes.USAGE_ASSISTANCE_NAVIGATION_GUIDANCE
<span class="lineno">  55 </span>  <span class="string">"assistanceSonification"</span> -> AudioAttributes.USAGE_ASSISTANCE_SONIFICATION
<span class="caretline"><span class="lineno">  56 </span>  <span class="string">"assistant"</span> -> <span class="warning">AudioAttributes.USAGE_ASSISTANT</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  57 </span>  <span class="string">"game"</span> -> AudioAttributes.USAGE_GAME
<span class="lineno">  58 </span>  <span class="string">"media"</span> -> AudioAttributes.USAGE_MEDIA
<span class="lineno">  59 </span>  <span class="string">"notification"</span> -> AudioAttributes.USAGE_NOTIFICATION
</pre>

<span class="location"><a href="../../src/main/java/com/livekit/reactnative/audio/AudioManagerUtils.kt">../../src/main/java/com/livekit/reactnative/audio/AudioManagerUtils.kt</a>:100</span>: <span class="message">Field requires API level 26 (current min is 24): <code>android.media.AudioManager#STREAM_ACCESSIBILITY</code></span><br /><pre class="errorlines">
<span class="lineno">  97 </span>        }
<span class="lineno">  98 </span>
<span class="lineno">  99 </span>        <span class="keyword">val</span> streamType = <span class="keyword">when</span> (streamTypeString) {
<span class="caretline"><span class="lineno"> 100 </span>            <span class="string">"accessibility"</span> -> <span class="warning">AudioManager.STREAM_ACCESSIBILITY</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 101 </span>            <span class="string">"alarm"</span> -> AudioManager.STREAM_ALARM
<span class="lineno"> 102 </span>            <span class="string">"dtmf"</span> -> AudioManager.STREAM_DTMF
<span class="lineno"> 103 </span>            <span class="string">"music"</span> -> AudioManager.STREAM_MUSIC
</pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/livekit/reactnative/LiveKitReactNative.kt">../../src/main/java/com/livekit/reactnative/LiveKitReactNative.kt</a>:14</span>: <span class="message">Do not place Android context classes in static fields (static reference to <code>JavaAudioDeviceModule</code> which has field <code>context</code> pointing to <code>Context</code>); this is a memory leak</span><br /><pre class="errorlines">
<span class="lineno"> 11 </span>
<span class="lineno"> 12 </span><span class="keyword">object</span> LiveKitReactNative {
<span class="lineno"> 13 </span>
<span class="caretline"><span class="lineno"> 14 </span>    <span class="warning">private lateinit <span class="keyword">var</span> adm: JavaAudioDeviceModule</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 15 </span>
<span class="lineno"> 16 </span>    <span class="keyword">val</span> audioDeviceModule: JavaAudioDeviceModule
<span class="lineno"> 17 </span>        get() {
</pre>
